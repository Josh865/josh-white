  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="I’m Josh White, a full-stack web developer with a special interest in front-end development and design. I’m currently working on the next version of eeds. Before that, I built web applications at Purdue University."
        />
      ...
      <main>
        <div className="sm:px-12">
          <div className="relative mx-auto max-w-7xl bg-white">
            <div className="relative overflow-hidden">
              <div className="relative z-10 max-w-3xl px-16 py-12">
                ...
                <p className="mt-6 text-base text-zinc-600">
                  I’m Josh White, a full-stack developer and architect with a special interest in
                  front-end development and design. I’m currently working at HealthStream. Before
                  that, I built web applications at Purdue University.
                </p>
                <p className="mt-6 text-base text-zinc-600">
                  I have a PhD in analytic philosophy from Purdue, where my research focused on
                  epistemology–specifically, the epistemic mechanisms and consequences of
                  enculturation.
                </p>
              </div>
              <div className="absolute left-0 top-1/4 scale-150 md:bottom-0 md:top-0 md:scale-[1.15]">
                <Image src={wavesImage} alt="" className="stroke-current" priority />
              </div>
            ...
            <div className="z-10 px-16 py-12">
                  ...
                  <div key={index}>
                    <div className="grid grid-cols-1 gap-8 py-12 md:grid-cols-[33%,1fr]">
                      <div className="flex flex-col">
                        ...
                        />
                        {project.stack ? (
                          <ul className="mt-4 flex items-center gap-x-2" role="list">
